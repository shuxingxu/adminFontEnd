...
<div class="page-container">
    <div class="page-header">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/userinfo/exhibition/'+this.$route.params.id }">展会信息</el-breadcrumb-item>
...
export default {
    ...
    // props:[userid],
    beforeCreate() {
        this.$axios.get('/api/admin/user/Info?id='+this.$route.params.id).then(data=>{
            this.axiosdata = data.data.data
            // console.log('返回的数据：',this.$route)
        });
    },
    mounted() {
        ...
        showdata(){
            ...
            showdata2(){
                ...
                },
                {
                    type: 7,
                    label: '用户来源',
                    title: this.axiosdata.user_source===1? '微信' : ( this.axiosdata.user_source===2 ? 'app' : '其他')
                },
                {
                    type: 7,
                    label: '城市',
