...
<div class="page">
    ...
    <div class="page-content">
        <table-tabs :page-tabs="pageTapsCard" @tabs-click="pageTapsClick">
            ...
            <nomal-table :table-json="tableJson" :border="true" :url="url" :axios-type="'get'" :page-size="20" slot="first">
            ...
            <nomal-table :table-json="tableJson2" :border="true" :url="url" :axios-type="'get'" :page-size="20" slot="second">
                <table-tabs :page-tabs="menus"></table-tabs>
                <table-button :buttons="buttons" @btn-click="btnClick"></table-button>
                <table-search :searchs="searchs"></table-search>
                <add-button :add-btn="addButton"></add-button>
