    ...
    <el-dialog title="联系" :visible.sync="shadow">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            <el-tab-pane label="短信" name="first">
                <el-form ref="form1" :model="form1" label-width="80px">
                    <el-form-item label="选择模板">
                        <el-select v-model="form1.region" placeholder="请选择短信模板" @change='selectchange'>
                        <el-option v-for="(v,i) in selectdata" :key="i" :label="v.template_name" :value="v.content" ></el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-tab-pane label="赠送优惠券" name="third">
                <nomal-table :table-json="tableJson2" :url="urlticket"></nomal-table>
                <el-button type="primary" @click="onSubmit3">确定</el-button>
                <el-button @click="shadow=false">取消</el-button>
            </el-tab-pane>
            <el-tab-pane label="赠送实物券" name="fourth">
                <nomal-table :table-json="tableJson3" :url="urlticket2"></nomal-table>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                selectdata:[],
                urlticket:`/api/admin/coupontemplate/index`,
                urlticket2:``,
                        ...
                        },
                        {
                            ...
                            "list": [
                                ...
                                },
                                {
                                    ...
                                    onClick(tablePage, self,row){
                                        self.$router.push({path: '/userincome?user_id=' + row.user_id })
                                    }
                ...
                tableJson2: {
                    ...
                    "column": [ //行
                        ...
                        },
                        {
                            ...
                            "align": "center",
                            "label": "有效期",
                            "prop": "coupon_template_expire",
                            "width": "",
                            formatter(row, column, columnIndex, rowIndex) {
                                return `${row.coupon_template_expire.coupon_template_expire_start_time}至${row.coupon_template_expire.coupon_template_expire_end_time}`
                            }
        ...
        created() {
            this.$axios.get('/api/admin/smstemplate/index',{
                params:{
                    page:1,
                    pagesize:10
                }
